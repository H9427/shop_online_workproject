...
<template>
  <div>
    ...
    <input type="radio" name="my_tabs_1" role="tab" class="tab" aria-label="Home" />
    <div role="tabpanel" class="tab-content p-10">Tab content 1</div>

    <input type="radio" name="my_tabs_1" role="tab" class="tab" aria-label="Clothes" checked />
    <div role="tabpanel" class="tab-content p-10">Tab content 2</div>

    <input type="radio" name="my_tabs_1" role="tab" class="tab" aria-label="Shoes" />
    <div role="tabpanel" class="tab-content p-10">Tab content 3</div>

    <!-- 切换风格 -->
    <div class="flex justify-center" style="margin-top: 5px; margin-bottom: 5px; margin-left: 5px">
      ...
      <button class="btn btn-sm" @click="$router.push('/login')" style="margin-left: 5px; margin-right: 5px">登录</button>
